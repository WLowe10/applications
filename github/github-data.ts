  ...
  try {
    const response = await fetch(
      ...
      )}`,
      {
        ...
        headers: {
          Authorization:
            "Bearer c1f659631e81c7e2e40063e0f483f15e2b5254b267c7794a",
          Cookie:
            "__cf_bm=rnVqtFbXpJzNgbYYoJZN8ydG4EMrioF7rz3pFqEQ98s-1726681291-1.0.1.1-ZKFkZRiGFVNq3zO1y5O2S_o96dCE84CS9nx30GtSH9qoq0bbm2tSRZAeZ9jVc1m.xFR.ApRTVWSHG1PFzfL3yg",
        },
      }
    );
